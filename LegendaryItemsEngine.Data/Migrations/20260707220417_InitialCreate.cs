        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItemOrders_Players_PlayerId",
                        column: x => x.PlayerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FulfillmentEvents_ItemOrders_ItemOrderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderLines_ItemOrders_ItemOrderId",
                        column: x => x.ItemOrderId,
                        principalTable: "ItemOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FulfillmentEvents_ItemOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemOrders_PlayerId",
                table: "ItemOrders",
                column: "PlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemOrders_Status",
                table: "ItemOrders",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderLines_ItemOrderId",
                table: "OrderLines",
                column: "ItemOrderId",
                unique: true);
